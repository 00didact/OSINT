...
webhose_access_token = "CHANGE ME"
...
def search_webhose(bitcoin_addresses):
    ...
    for bitcoin_address in bitcoin_addresses:
        ...
        # loop continually unti we have retrieved all results at Webhose
        while result['totalResults'] > 0:
            ...
            if bitcoin_to_hidden_services.has_key(bitcoin_address):
                print "[*] Discovered %d hidden services connceted to %s" % (len(bitcoin_to_hidden_services[bitcoin_address]),bitcoin_address)
